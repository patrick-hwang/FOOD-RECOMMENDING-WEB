export const TAG_DEFINITIONS = {
    ...
    "thảo mộc có mùi hương đặc trưng" : ["sả", "hồi", "quế", "gừng", "lá dứa", "vani"],
    "thời điểm/dịp" : ["bữa sáng", "ăn vặt", "tráng miệng", "buổi đêm", "buổi trưa"],
    ...
    "độ béo" : ["không béo", "béo nhẹ", "béo vừa", "béo đậm"],
    "độ mặn" : ["nhạt", "hơi mặn", "mặn vừa", "mặn đậm"],
    "độ chua" : ["không chua", "chua nhẹ", "chua vừa", "chua đậm"],
    "thức uống" : ["cà phê", "trà sữa", "nước ép/ sinh tố", "có cồn", "nước có ga"],
    "đồ ăn ngọt" : ["chè", "kem tươi", "kem cheese", "sữa chua", "trân châu", "thạch", "kem trứng", "flan"],
    "không phải trái cây" : ["rau má", "matcha", "cacao", "dừa"],
    "trái cây" : ["họ cam", "dâu/phúc bồn tử", "đào", "vải/nhãn", "xoài", "cóc", "bơ", "táo", "mít", "sầu riêng"],
    ...
    "giá tiền" : ["siêu rẻ", "rẻ", "bình dân", "sang", "nhà hàng", "cao cấp", "thượng lưu", "đại gia"]
}
